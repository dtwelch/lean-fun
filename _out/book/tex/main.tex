...
The proof uses lean4's induction tactic on \LeanVerb|m|.For the base case, we must show:\begin{verbatim}
plus .zero .zero = .zero
\end{verbatim}
simplifying with the base case of addition, this is straightforward.For the inductive case, we must show:\begin{verbatim}
...
for \LeanVerb|congArg|:\begin{verbatim}
\PLFAForall{} {α β : Sort} ->
\PLFAForall{} {a1 a2 : α} ->
\PLFAForall{} (f : α -> β) ->
